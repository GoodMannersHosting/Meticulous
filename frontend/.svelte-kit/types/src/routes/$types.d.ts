...
type LayoutRouteId = RouteId | "/" | "/agents" | "/auth/callback" | "/auth/login" | "/dashboard" | "/jobs" | "/pipelines" | "/pipelines/[id]" | "/pipelines/new" | "/projects" | "/projects/[id]" | "/runs" | "/runs/[id]" | "/settings" | "/settings/security" | "/workflows" | null
